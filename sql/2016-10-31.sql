...
-- Dumping data for table wbs.permissions: ~33 rows (approximately)
...
-- Dumping data for table wbs.rolesPermissions: ~41 rows (approximately)
...
INSERT INTO `users` (`id`, `login`, `googleId`, `facebookId`, `instagramId`, `githubId`, `vkId`, `twitterId`, `dropboxId`, `email`, `passwordHash`, `roleId`, `createdAt`, `updatedAt`) VALUES
	(1, 'rez1dent3', NULL, NULL, NULL, '5111255', '77525486', NULL, NULL, 'maksim.babichev95@gmail.com', '$2y$10$5PN0fk6ih8MbIxgb9Yhu0ORWKn7srgXBfAK4xxGBeU4ELv0SiABbC', 1, '2016-10-06 10:45:45', '2016-10-31 11:05:32');
