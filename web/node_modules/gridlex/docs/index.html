...
&lt;link rel="stylesheet" href="<a href="https://cdnjs.cloudflare.com/ajax/libs/gridlex/2.2.4/gridlex.min.css">https://cdnjs.cloudflare.com/ajax/libs/gridlex/2.2.4/gridlex.min.css</a>"></code></pre>
            ...
            <div class="col-12">
                ...
                <ul>
                    <li><a href="expo.html" aria-label="View websites using Gridlex">List of websites using Gridlex</a></li>
...
&lt;/div></code></pre>
        ...
        <div class="grid-6-noGutter-noBottom">
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=1" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=2" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=3" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=4" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=5" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=6" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=7" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=8" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=9" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=10" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=11" width="220" height="220" alt="">
                </div>
            </div>
            <div class="col">
                <div class="demo">
                    <img src="//unsplash.it/220/?random=12" width="220" height="220" alt="">
                </div>
            </div>
        </div>
...
<pre class="doc"><code>off-* (0 to 11)
  ...
  -0: reboot the offset (can be usefull in responsive mode with key-suffixes)</code></pre>
    ...
    <section>
        ...
        <iframe width="100%" height="430" src="http://caniuse.com/flexbox/embed/"></iframe>
    </section>
