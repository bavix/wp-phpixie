...
class SocialRows extends React.Component {
    ...
    row(model) {
        ...
        return <tr key={model.id}>
            ...
            <td>
                <ButtonDelete key={model.id} api={'/api/soc/dealer/' + model.dealerId + '/social/' + model.socialId}/>
            </td>
        </tr>;
    }
...
class HeadingRows extends React.Component {
    ...
    row(model) {
        return <tr key={model.id}>
            ...
            <td>{model.title}</td>
            <td>
                <ButtonDelete key={model.id} api={'/api/soc/dealer/' + model.dealerId + '/heading/' + model.id}/>
            </td>
        </tr>;
    }
...
class DealerRows extends React.Component {
    ...
    row(model) {
        return <tr key={model.id}>
            ...
            <td>{model.name}</td>
            <td>
                <ButtonDelete key={model.id} api={'/api/soc/dealer/' + model.dealerId + '/dealer/' + model.id}/>
            </td>
        </tr>;
    }
...
class AddressRows extends React.Component {
    ...
    row(model) {
        return <tr key={model.id}>
            ...
            <td>
                <ButtonDelete key={model.id} api={'/api/soc/dealer/' + dealerId + '/address/' + model.id}/>
            </td>
        </tr>;
    }
