        ...
        value: function row(model) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'td',
                    null,
                    React.createElement(ButtonDelete, { key: model.id, api: '/api/soc/dealer/' + model.dealerId + '/social/' + model.socialId })
                )
            );
        }
    }, {
        ...
        value: function row(model) {
            return React.createElement(
                ...
                React.createElement(
                    'td',
                    null,
                    React.createElement(ButtonDelete, { key: model.id, api: '/api/soc/dealer/' + model.dealerId + '/heading/' + model.id })
                )
            );
        }
    }, {
        ...
        value: function row(model) {
            return React.createElement(
                ...
                React.createElement(
                    'td',
                    null,
                    React.createElement(ButtonDelete, { key: model.id, api: '/api/soc/dealer/' + model.dealerId + '/dealer/' + model.id })
                )
            );
        }
    }, {
        ...
        value: function row(model) {
            return React.createElement(
                ...
                React.createElement(
                    'td',
                    null,
                    React.createElement(ButtonDelete, { key: model.id, api: '/api/soc/dealer/' + dealerId + '/address/' + model.id })
                )
            );
        }
    }, {
...
$(function () {
    ...
    function tableHeadingInit(json) {
        if (typeof json.data !== "undefined") {
            ...
            json = json.data.map(function (data) {
                data.dealerId = $formHeading.data('id');
    ...
    function tableDealerInit(json) {
        if (typeof json.data !== "undefined") {
            ...
            json = json.data.map(function (data) {
                data.dealerId = $formDealer.data('id');
    ...
    $('[data-updated="dealer"]').submit(function () {
    ...
    fetch('/api/soc/heading?terms[dealers.id]=' + $formHeading.data('id'), {
        method: 'GET',
        credentials: 'include'
    }).then(response).then(tableHeadingInit).catch(function () {
        return undefined;
    ...
    fetch('/api/soc/dealer?terms[dealers.id]=' + $formDealer.data('id'), {
        method: 'GET',
        credentials: 'include'
    }).then(response).then(tableDealerInit).catch(function () {
        return undefined;
